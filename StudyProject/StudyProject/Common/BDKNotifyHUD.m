...
#define kBDKNotifyHUDDefaultOpacity      0.65f
#define kBDKNotifyHUDDefaultPadding      8.0f
...
+ (id)notifyHUDWithImage:(UIImage *)image text:(NSString *)text {
    ...
    _HUD = [[self alloc] initWithImage:image text:text];
...
- (void)recalculateHeight {
    ...
    rect.origin.x = (self.backgroundView.frame.size.width - _textLabel.frame.size.width ) / 2 - 15;
